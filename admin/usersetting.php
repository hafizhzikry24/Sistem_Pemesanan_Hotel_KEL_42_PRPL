    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php"> MENU UTAMA  </a>
            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Tambah User name dan Password</h4>
                                        </div>
										<form method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                            <label>Tambah User name Baru</label>
                                            <input name="newus"  class="form-control" placeholder="Masukkan Username">
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                                            <label>Tambah Password baru</label>
                                            <input name="newps"  class="form-control" placeholder="Masukkan Password">
											</div>
                                        </div>
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Ganti User name dan Password</h4>
                                        </div>
										<form method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                            <label>Ganti User name</label>
                                            <input name="usname" value="<?php echo $us; ?>" class="form-control" placeholder="Masukkan User name">
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
